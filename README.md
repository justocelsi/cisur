...
- **Instructivos para la clienta:** [`docs/tati-mercadopago.pdf`](docs/tati-mercadopago.pdf) · [`docs/tati-editar-la-web.pdf`](docs/tati-editar-la-web.pdf) · [`docs/tati-cobrar-antes.pdf`](docs/tati-cobrar-antes.pdf)
