...
const MENSAJES = [
  ...
  // El límite de MAILS va antes que el genérico de rate limit: si no, /rate
  // limit/ lo sombrea y nunca se alcanza. La diferencia importa porque el
  // consejo es distinto: los intentos se liberan en un minuto, los mails en una
  // hora. Decirle «esperá un minuto» a quien pidió recuperar su contraseña la
  // manda a reintentar cinco veces contra una puerta cerrada.
  [
    /email rate limit exceeded|over_email_send_rate_limit/i,
    "Se alcanzó el límite de mails por hora. Probá de nuevo dentro de una hora.",
  ],
  [
